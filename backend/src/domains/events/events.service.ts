...
import { queryEventsByEmail, upsertEvent, upsertEvents } from './events.repository';
...
export const fetchEvents = async (
   ...
   return queryEventsByEmail(email)
}
...
export const createEvent = async (accessToken: string, event: Omit<InserEventsRow, 'googleId'>) => {
